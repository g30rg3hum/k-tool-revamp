...
export const metadata: Metadata = {
    title: "Get a Quote | K-Tool Engineering | Precision Engineering in Malaysia",
    description:
    ...
    return (
        <div className={SPACE_BETWEEN_SECTIONS}>
            <div
                className={clsx(
                    CONTENT_LAYOUT,
                    "flex flex-col gap-9 md:flex-row"
                )}
            >
                <FadeOnScroll className="md:max-w-[400px]">
                    <SectionHeading className="mb-3">
                        Already have an{" "}
                        <span className="text-primary">idea</span> for a{" "}
                        <span className="text-primary">project?</span>
                    </SectionHeading>
                    <p className="mb-6">
                        Let us know the specifics and we&apos;ll get back to you
                        with a complete quotation, timeline, and our
