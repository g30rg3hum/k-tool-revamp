...
export const metadata: Metadata = {
    title: "Equipment | K-Tool Engineering | Precision Engineering in Malaysia",
    description:
...
const mainEquipment = [
    {
        heading: (
            <div className="flex items-center gap-3 mb-6 flex-wrap">
                <ContentHeading className="shrink-0">
                    Profile grinder
                </ContentHeading>
        ...
        <div className={SPACE_BETWEEN_SECTIONS}>
                ...
                <div className="flex flex-col gap-9">
                    <FadeOnScroll>
                        ...
                        <SectionHeading className="mb-6">
                            Guaranteeing{" "}
                            <span className="text-primary">precision</span> with
                            the{" "}
                        ...
                        <p>
                            At K-Tool Engineering, we pride ourselves on using
                            the best technologies available to ensure we deliver
            ...
            <div className={CONTENT_LAYOUT}>
                <FadeOnScroll className="mb-9">
                    ...
                    <p>
                        On top of the main equipment above, we also have
                        specific machinery that help us to deliver outputs that
                        are of the highest quality in the industry.
                    </p>
                </FadeOnScroll>
                <div className="grid gap-6 lg:grid-cols-2">
            ...
            <div className={CONTENT_LAYOUT}>
                ...
                <FadeOnScroll>
                    <p className="mb-3">
                        We also have a full range of supporting equipment,
                        including{" "}
                        <span className="font-bold">
                            grinding and milling machines, laser engraving,
                            abrasive blasting machines,
                        </span>{" "}
                        and other precision tools.
                    </p>
                    <p>
                        These together ensure smooth production and maintain the
                        highest quality standards for the work produced on the
