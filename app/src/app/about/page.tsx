...
export const metadata = {
    title: "About Us | K-Tool Engineering | Precision Engineering in Malaysia",
    description:
                ...
                <div className="flex flex-col md:flex-row gap-9 justify-between">
                    <div className="md:w-[60%] flex flex-col">
                        ...
                        <SectionHeading className="mb-6">
                            ...
                            <span className="text-primary">decades</span>, we
                            have been at the{" "}
                        ...
                        <p>
                            We are an international, leading ISO-certified
                            precision engineering company based in Malaysia. Mr.
                            Tan Hoo Peng founded K-Tool Engineering in 1995, and
                            ever since we have been committed to delivering
                            high-precision tooling solutions to key sectors of
                            the electronics industry. These include
                            semiconductors, connectors, stamping parts, and many
                            more.
                        </p>
                    </div>
                    <Image
            ...
            <div className={CONTENT_LAYOUT}>
                ...
                <div className="flex flex-col md:flex-row gap-9">
                    <FadeOnScroll className="bg-white md:w-[50%] p-6 rounded-md border border-neutral">
                        ...
                        <p>
                            Delivering precision engineering solutions with
                            uncompromising quality and speed, transforming our
                            clients&apos; complex designs into perfectly
                            manufactured components with advanced technology and
                    ...
                    <FadeOnScroll className="bg-white md:w-[50%] p-6 rounded-md border border-neutral">
                        ...
                        <p>
                            We envision a future where we are the precision
                            engineering partner that innovators from all over
                            the world trust first, known for solving difficult
                            challenges through technical excellence and genuine,
            ...
            <div className={CONTENT_LAYOUT}>
                <div className="flex flex-col gap-9 md:gap-18 md:flex-row md:justify-between">
                    <FadeOnScroll className="md:max-w-sm lg:max-w-lg">
                        ...
                        <p>
                            Our commitment to our core values helps us to
                            deliver exceptional results every time - values that
                            we live by during every project we take on and every
                ...
                <FadeOnScroll>
                    ...
                    <div className="md:text-center md:mx-auto flex flex-col items-center mb-9">
                        ...
                        <p className="md:max-w-2xl">
                            We have continuously improved our processes,
                            embraced new technologies, and expanded our
                            workspaces to better serve our clients and adapt to
                ...
                <div className="flex flex-col items-center gap-12">
                    <FadeOnScroll className="max-w-4xl flex flex-col md:flex-row items-center bg-white rounded-md border border-neutral p-3">
                        <div className="md:w-[50%] p-6 order-1">
                            ...
                            <p>
                                We began as a small, humble workshop in a rented
                                space, initially focused on producing spare
                                parts. Since then, we&apos;ve experienced rapid
                                growth in both our workforce and machinery.
                            </p>
                        </div>
                        <Image
                    ...
                    <FadeOnScroll className="max-w-4xl flex flex-col md:flex-row items-center bg-white border border-neutral p-3 rounded-md">
                        ...
                        <div className="md:w-[50%] p-6 order-1 md:order-2">
                            ...
                            <p>
                                Just two years later, we moved into our own
                                12,000 square foot semi-detached factory in
                                Bayan Lepas — a thriving industrial hub on the
                                island of Penang in Malaysia. This allowed us to
                                expand our production capabilities and better
                    ...
                    <FadeOnScroll className="max-w-4xl flex flex-col md:flex-row items-center bg-white border border-neutral p-3 rounded-md">
                        <div className="md:w-[50%] p-6">
                            ...
                            <p>
                                After seeing continued success from our first
                                factory, we expanded into an advanced 28,000
                                square foot facility, also in Bayan Lepas, to
                    ...
                    <FadeOnScroll className="max-w-4xl flex flex-col md:flex-row items-center bg-white border border-neutral p-3 rounded-md">
                        <div className="md:w-[50%] p-6 order-1 md:order-2">
                            ...
                            <p>
                                We sold our semiconductor mold division to TOWA
                                Corporation, a leading Japanese OEM in
                                semiconductor auto-molding and packaging
                                equipment. This enabled us to concentrate on
                                ultra-precision engineering in the stamping and
                                connector industry.
                            </p>
                        </div>
                        <Image
                    ...
                    <FadeOnScroll className="max-w-4xl flex flex-col md:flex-row items-center bg-white border border-neutral p-3 rounded-md">
                        <div className="md:w-[50%] p-6">
                            ...
                            <p>
                                We commissioned a 50,000 square foot
                                state-of-the-art facility to further elevate our
                                capabilities and strengthen our position as a
                                leader in ultra-precision manufacturing in
                                Malaysia.
                            </p>
                        </div>
                        <Image
